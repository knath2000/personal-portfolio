        ...
        {PROJECTS.map((p, idx) => (
          ...
          >
            <div className="relative aspect-[16/9] w-full">
              <Image src={p.img} alt={p.title} fill sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" className="object-cover" priority={idx===0} fetchPriority={idx===0?"high":"auto"} />
            </div>
            <div className="p-4">
